  ...
  return (
    <div className="min-h-screen flex bg-slate-100 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-20 bg-white border-b border-slate-200 px-4 md:px-6 flex items-center justify-between">
        ...
        <main className="flex-1 overflow-auto p-4 md:p-6">
          ...
          <div className="flex flex-col lg:flex-row flex-wrap gap-3 mb-6">
            <button
              ...
              className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-3 rounded-2xl transition shadow-sm"
            >
              <Plus size={18} />
              Create Lead
            </button>
            ...
            <CSVLink
              data={leads}
              filename="leads.csv"
              className="flex items-center justify-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white px-5 py-3 rounded-2xl transition shadow-sm"
            >
              <Download size={18} />
              Export CSV
            </CSVLink>
            ...
            <select
              ...
              className="w-full md:w-auto px-4 py-3 rounded-2xl border border-slate-200 bg-white outline-none"
            >
              <option value="">
                All Status
              </option>
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center justify-center gap-2">
                            <button
                              ...
                              className="w-9 h-9 rounded-xl bg-green-100 flex items-center justify-center text-green-600 hover:bg-green-200 transition"
                            >
                              <Pencil
                                size={16}
                              />
